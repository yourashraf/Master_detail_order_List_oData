		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Master Detail",
									"targetURL": "#masterdetailmasterdetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"masterdetailmasterdetail-display": {
								"semanticObject": "masterdetailmasterdetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=masterdetail.masterdetail",
									"url": sap.ui.require.toUrl("masterdetail/masterdetail")
								}
							}
						}
					}
